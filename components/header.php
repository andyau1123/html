<header>
    <div class="container" id="banner" style="width:100%">
        <div class="row" style="position: relative;">
            <div class="banner-grid">
				...
				<div class="grid-img">
                    <img src="images/APOF_logo.jpg" class="img-responsive logo" alt="APOF">
                </div>
				<div class="grid-img">
                    <img src="images/GBATA_logo.jpg" class="img-responsive logo" alt="GBATA">
                </div>
				<div class="grid-img">
    ...
    <div class="thumbnail_b text-center">
        ...
        <div class="banner-wrapper"><img src="images/banner/22042023_Conference_banners.png" class="img-responsive" id="main-banner" width="100%" /></div>
    </div>
</header>